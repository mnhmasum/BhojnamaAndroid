...
public class FooddetailsFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		txtFoodName.setText(BhojNamaSingleton.getInstance().getHottestInfoList().get(getArguments().getInt("position")).getHottestFoodItemList().get(getArguments().getInt("position")).getFoodTitle());
		
		txtIngrediants = (TextView) rootView.findViewById(R.id.ingrediants);
		txtIngrediants.setText(BhojNamaSingleton.getInstance().getHottestInfoList().get(getArguments().getInt("position")).getHottestFoodItemList().get(getArguments().getInt("position")).getIngredients());
		
		txtPrice = (TextView) rootView.findViewById(R.id.price);
		txtPrice.setText(BhojNamaSingleton.getInstance().getHottestInfoList().get(getArguments().getInt("position")).getHottestFoodItemList().get(getArguments().getInt("position")).getPrice());
