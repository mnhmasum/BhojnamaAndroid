...
public class UploadImageAsyncTask extends AsyncTask<String, Void, Void> {
	...
	protected Void doInBackground(String... params) {
			try {
				...
				//reqEntry.addPart("photos", new StringBody("1213"));
				FileBody bin = new FileBody(new File(params[2]), "image/jpeg");
				reqEntry.addPart("photos", bin);
				reqEntry.addPart("taken-on", new StringBody("10.30"));
				reqEntry.addPart("user-id", new StringBody("1"));
				reqEntry.addPart("key", new StringBody(""));
